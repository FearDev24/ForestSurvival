...
- **palavra sobre magenta precisa de corte por cor, não só por conexão.** O miolo de um A, de um O ou de um R é fundo cercado de tinta por todos os lados: não encosta na borda, então sobrevivia ao corte e virava um triângulo magenta dentro da letra. `tools/preparar_painel_ui.py` passou a matar também os bolsões ilhados que tenham a cor **chapada** do fundo — g < 20, r e b acima de 150 e próximos entre si. O critério de cor chapada é o que separa o miolo de um A, rgb(249,2,247), das partículas de cinza que caem sob a palavra, rgb(170,53,120), que são arte e ficam;
- **o que sobra de rosa vira cinza, não buraco.** A beirada de cada letra foi antisserrilhada contra o magenta e guarda uma mistura rosada — 0,1% da tinta, mas rosa num quadro escuro salta. A troca é por cinza de mesma luminância, e não por transparência, porque parte desses pixels são as próprias partículas de cinza da arte. É seguro varrer tudo porque a paleta do jogo não tem rosa nem roxo;
- **duas palavras que dividem uma tela têm de sair da mesma sessão, na mesma altura de letra.** Os títulos de derrota e vitória vieram com o mesmo canvas e o mesmo corpo, e por isso os recortes saíram com a **mesma largura** — encaixar os dois num slot com aspecto preservado dá então a mesma escala nos dois, e a letra não muda de tamanho entre os desfechos. Encaixar por altura mudaria, porque as partículas de cinza esticam a peça da derrota;
